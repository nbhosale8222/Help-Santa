...
function About() {
  ...
  const AboutItems = [
    {
      id: 1,
      title: "Stage 1 — Riddle Trail",
      subtitle: "Beginner Puzzles",
      description: "Solve introductory SQL riddles to learn core concepts and unlock the first map regions.",
      icon: "🗺️",
    ...
    {
      id: 2,
      title: "Stage 2 — Logic Trials",
      subtitle: "Intermediate Challenges",
      description: "Use clues and SQL logic (filters, joins) to track Santa and the scattered reindeer.",
      icon: "🧩",
    ...
    {
      id: 3,
      title: "Stage 3 — Rescue Ops",
      subtitle: "Timed & Strategic",
      description: "Recover sleigh parts and reindeer using advanced queries. Lives are limited — plan your moves.",
      icon: "❤️",
    ...
    {
      id: 4,
      title: "Stage 4 — Flight of Deliveries",
      subtitle: "Final Challenge",
      description: "Combine everything you’ve learned to restore the sleigh and deliver gifts across the map.",
      icon: "🌿",
